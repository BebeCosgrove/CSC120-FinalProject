...
public class MapGame{
   ...
   private Building synergy;
   private Building woodstar;
   private Building bread;
   private Building thornes;
   private Building music;
   private Building uo;
   private Building mosaic;
   private Building policeStation;
   private Building forbes;
   private Building pulaski;
   private Building cityHall;
   private Building cedarChest;
   private Building troots;
   private Building bass;
   private Building garden;
   private Building scam;
   private Building smithGate;
    ...
    public MapGame(){
        ...
        synergy = new Building("Synergy", "2 Tyler Ct");
        woodstar = new Building("Woodstar Cafe", "46 College Ln");
        bread = new Building("hungry ghost bread", "44 College Ln");
        thornes = new Building("Thornes Marketplace", "150 Main St");
        music = new Building("Academy of Music", "274 Main St");
        uo = new Building("Urban Outfitters", "109 Main St");
        troots = new Building("T.ROOTS", "249 Main St");
        mosaic = new Building("Mosaic Cafe", "78 Masonic St");
        policeStation = new Building("Northampton Police Department", "29 Center St");
        forbes = new Building("Forbes Library", "20 West St");
        ...
        scam = new Building("Smith College Museum of Art", "20 Elm St");
...
=======
    ...
    // put object in constructor for each instance of building 
        ...
        // make this a method like move() so we don't have this just in main and we can access it from game loop
    //     while (true) {
    //         System.out.println("\nWhere do you want to go? (North/South/East/West or Restart): ");
    //         String input = scanner.nextLine().trim();
